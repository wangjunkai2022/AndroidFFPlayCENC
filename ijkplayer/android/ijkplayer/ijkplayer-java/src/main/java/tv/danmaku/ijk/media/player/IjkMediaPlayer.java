...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static void loadLibrariesOnce(IjkLibLoader libLoader) {
        synchronized (IjkMediaPlayer.class) {
            if (!mIsLibLoaded) {
                ...
                libLoader.loadLibrary("ijkffmpeg_hy");
                libLoader.loadLibrary("ijksdl_hy");
                libLoader.loadLibrary("ijkplayer_hy");
                mIsLibLoaded = true;
            }
        }
    }
    ...
    public Bitmap getCurrentFrame() {
        Bitmap bitmap = null;// = Bitmap.createBitmap(getVideoWidth(), getVideoHeight(), Bitmap.Config.RGB_565);
        try {
            bitmap = Bitmap.createBitmap(getVideoWidth(), getVideoHeight(), Bitmap.Config.ARGB_8888);
